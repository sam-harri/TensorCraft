  ...
  return (
    <div className="relative h-full text-gray-700">
      <div
        ...
        } z-[51] border-r border-t border-gray-300 rounded-r-3xl`}
      >
      ...
      <div
        ...
        } transition-transform bg-white cursor-pointer p-1 h-20 flex items-center justify-center rounded-r-lg z-[52] border-r-2 border-y border-gray-300`}
