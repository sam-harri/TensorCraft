...
export type Dropout2dLayerNodeData = {
  p: number | null;
  inplace: boolean;
...
const Dropout2DLayerNode: React.FC<NodeProps<Dropout2dLayerNodeData>> = (props) => {
  ...
  return (
    <div className="bg-white shadow-md rounded border border-gray-300 w-72 relative">
      ...
      <NodeHeader title="Dropout2D Layer" isCollapsed={isCollapsed} setIsCollapsed={setIsCollapsed} imageSource="dropout/dropout2d.png" imageAlt="Dropout2D" props={props} />
      {!isCollapsed && (
        <div className="p-4 border-t border-gray-200">
          ...
          <ShapeLabel input={true} shape={props.data.inputShape || 'Not Connected'} shapeHintMessage="The shape of the input tensor is expected to be (Batch, Channel, Height, Width)" />
...
export default Dropout2DLayerNode;
