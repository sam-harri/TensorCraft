  ...
  return (
    <div className="relative h-full text-gray-700">
      <div
        ...
        } z-[53] border-l border-t border-gray-300 rounded-l-3xl`}
      >
      ...
      <div
        ...
        } transition-transform bg-white cursor-pointer p-1 h-20 flex items-center justify-center rounded-l-lg border-l-2 border-y border-gray-300 z-[54]`}
