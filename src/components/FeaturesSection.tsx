...
const FeaturesSection: React.FC = () => {
  ...
  return (
    <section ref={sectionRef} className="container mx-auto px-4 lg:w-2/3 md:mt-32 mt-96">
      ...
      <div className={`grid grid-cols-1 md:grid-cols-3 gap-8 ${isVisible ? 'animate__animated animate__slideInUp' : ''}`}>
        <div className="flex flex-col items-center relative">
          ...
          <div className="absolute bottom-1/3 left-0  w-60 h-60 bg-pink-400 opacity-0 rounded-full blur-3xl animate__animated animate__fadeIn animate__delay-1s -z-50"></div>
