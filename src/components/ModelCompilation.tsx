  ...
  return (
    <div className="relative h-full text-gray-700">
      <div
        ...
        } w-[50vw] z-[53] border-l border-t border-gray-300 rounded-l-3xl flex flex-col transition-transform duration-1000 overflow-hidden`}
      >
        <ModelCompilationContent isCollapsed={isCollapsed}/>
      </div>
      <div
        className={`absolute transform mt-72 -translate-y-1/2 right-0 ${
          isCollapsed ? "translate-x-0" : "-translate-x-[calc(50vw-1px)]"
