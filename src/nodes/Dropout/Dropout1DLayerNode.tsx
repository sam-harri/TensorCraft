...
export type Dropout1dLayerNodeData = {
  p: number | null;
  inplace: boolean;
...
const Dropout1DLayerNode: React.FC<NodeProps<Dropout1dLayerNodeData>> = (props) => {
  ...
  return (
    <div className="bg-white shadow-md rounded border border-gray-300 w-72 relative">
      ...
      <NodeHeader title="Dropout1D Layer" isCollapsed={isCollapsed} setIsCollapsed={setIsCollapsed} imageSource="dropout/dropout.png" imageAlt="Dropout1D" props={props} />
      {!isCollapsed && (
        <div className="p-4 border-t border-gray-200">
          <InputField
            ...
            hintMessage="The probability of a channel being zeroed out. Default: 0.5."
          ...
          <ShapeLabel input={true} shape={props.data.inputShape || 'Not Connected'} shapeHintMessage="The shape of the input tensor is expected to be (Batch, Channel, Sequence Length)" />
...
export default Dropout1DLayerNode;
